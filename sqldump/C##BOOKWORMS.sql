...
-- ----------------------------
CREATE OR REPLACE
FUNCTION "C##BOOKWORMS"."TIMEDIFF" AS
BEGIN
			days := SYSDATE - D;
...
CREATE SEQUENCE "C##BOOKWORMS"."AUTHOR_SEQUENCE" MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 CACHE 20;

-- ----------------------------
-- Sequence structure for BOOK_SEQUENCE
-- ----------------------------
DROP SEQUENCE "C##BOOKWORMS"."BOOK_SEQUENCE";
CREATE SEQUENCE "C##BOOKWORMS"."BOOK_SEQUENCE" MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 CACHE 20;

-- ----------------------------
-- Sequence structure for COMMENT_SEQUENCE
-- ----------------------------
DROP SEQUENCE "C##BOOKWORMS"."COMMENT_SEQUENCE";
CREATE SEQUENCE "C##BOOKWORMS"."COMMENT_SEQUENCE" MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 CACHE 20;

-- ----------------------------
-- Sequence structure for GENRE_SEQUENCE
-- ----------------------------
DROP SEQUENCE "C##BOOKWORMS"."GENRE_SEQUENCE";
CREATE SEQUENCE "C##BOOKWORMS"."GENRE_SEQUENCE" MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 CACHE 20;

-- ----------------------------
-- Sequence structure for PUBLISHER_SEQUENCE
-- ----------------------------
DROP SEQUENCE "C##BOOKWORMS"."PUBLISHER_SEQUENCE";
CREATE SEQUENCE "C##BOOKWORMS"."PUBLISHER_SEQUENCE" MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 CACHE 20;

-- ----------------------------
-- Sequence structure for QUOTE_SEQUENCE
-- ----------------------------
DROP SEQUENCE "C##BOOKWORMS"."QUOTE_SEQUENCE";
CREATE SEQUENCE "C##BOOKWORMS"."QUOTE_SEQUENCE" MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 CACHE 20;

-- ----------------------------
-- Sequence structure for READER_SEQUENCE
-- ----------------------------
DROP SEQUENCE "C##BOOKWORMS"."READER_SEQUENCE";
CREATE SEQUENCE "C##BOOKWORMS"."READER_SEQUENCE" MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 CACHE 20;

-- ----------------------------
-- Sequence structure for REVIEW_SEQUENCE
-- ----------------------------
DROP SEQUENCE "C##BOOKWORMS"."REVIEW_SEQUENCE";
CREATE SEQUENCE "C##BOOKWORMS"."REVIEW_SEQUENCE" MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 CACHE 20;

-- ----------------------------
-- Sequence structure for WALLPOST_SEQUENCE
-- ----------------------------
DROP SEQUENCE "C##BOOKWORMS"."WALLPOST_SEQUENCE";
CREATE SEQUENCE "C##BOOKWORMS"."WALLPOST_SEQUENCE" MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 CACHE 20;
